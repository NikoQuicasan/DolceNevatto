        ...
        <div className="flex justify-between items-center">
          ...
          <nav>
            <ul className="flex space-x-6">
              <li>
                <Link to="/" className="font-medium text-gray-700 hover:text-[#795c8c]">Inicioss</Link>
              </li>
              <li>
    ...
    <footer className="bg-gray-800 text-white">
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link to="/catalogo" className="text-gray-300 hover:text-white">Catálogo</Link></li>
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 text-center">
          <p className="text-gray-300">© 2025 Dolce Nevatto. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
